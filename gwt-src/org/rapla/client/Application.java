...
@Singleton
public class Application implements DetailSelectEventHandler,
		ApplicationView.Presenter {
	...
	public void createApplication() {
		...
		load.get(new AsyncCallback<VoidResult>() {
			...
			public void onSuccess(VoidResult result) {
				try {
					Collection<Allocatable> allocatables = Arrays.asList(facade
							.getAllocatables());
					logger.info("loaded " + allocatables.size()
							+ " resources. Starting application");
					start();
